export const Requirement = () => {
    return (
        <section className="relative w-full bg-gray-200">
            <div>
                <h1 className= "text-blue-300 text-5xl font-black flex justify-center pt-10">REQUIREMENT</h1>
            </div>
            ...
            <div className= "flex justify-center w-full pt-8">
                <div className="bg-white border-2 border-black p-10 rounded-lg font-xl leading-loose max-w-3xl mx-auto">
            ...
            <div className="w-full flex justify-center">
                <h2 className="text-blue-300 font-black text-5xl flex justify-center pt-10">
                    RECURUIT INFO
                </h2>
            </div>
            ...
            <div className="w-full justify-center pt-8 pb-12">
                <div className="bg-white border-2 border-black p-10 rounded-lg font-xl leadind-loose font-medium text-center max-w-3xl mx-auto">
