        ...
        <h1 className="text-black text-5xl font-black flex justify-center pt-12">
          注意事項
            ...
            <div className="flex w-full pt-12 justify-center">
                <div className="bg-white border-2 border-black p-10 rounded-lg text-base lg:text-lg font-xl leadind-loose font-medium text-left max-w-[90%] lg:max-w-3xl mx-auto">
