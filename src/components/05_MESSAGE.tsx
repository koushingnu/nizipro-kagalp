...
export const Message = () => {
    return (
        <section className="relative w-full bg-white">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 w-11/12 mx-auto pt-10 px-25">
                <div className="flex flex-col text-loose items-center">
                    <img src= "/虹プロ画像/虹プロ画像/メッセージ/S__16629823.jpg" className="w-128 h-auto rounded-xl " />
                    <p className="text-yellow-300 font-black text-4xl pt-6 drop-shadow-lg">
                        あきと
                    </p>
                        <p className="font-black pt-6 text-left">
                            イエロー担当のあきとです！<br />
