            ...
            <div className="grid grid-cols-3 gap-12 w-11/12 mx-auto pt-10">
                <div className="flex flex-col text-loose items-center">
                    ...
                    <p className="text-yellow-300 font-black text-3xl pt-6">
                        ...
                        <p className="font-black pt-6 text-center">
                            イエロー担当のあきとです！<br />
                ...
                <div className="flex flex-col items-center">
                    <img src= "/虹プロ画像/虹プロ画像/メッセージ/S__16629824.jpg" className="w-full h-auto rounded-xl hover:scale-110 transform transition duration-200" />
                    <p className="text-green-300 font-black text-3xl pt-6">
                        けんご
                    </p>
                        <p className="font-black pt-6 text-center">
                            みどり担当のけんごです！<br />
                ...
                <div className="flex flex-col items-center">
                    <img src= "/虹プロ画像/虹プロ画像/メッセージ/S__16629825.jpg" className="w-full h-auto rounded-xl hover:scale-110 transform transition duration-200" />
                    <p className="text-red-300 font-black text-3xl pt-6">
                        だいや
                    </p>
                        <p className="font-black pt-6 text-center">
                            赤色担当のだいやです！<br />
                ...
                <div className="flex flex-col items-center">
                    <img src= "/虹プロ画像/虹プロ画像/メッセージ/S__16629826.jpg" className="w-full h-auto rounded-xl hover:scale-110 transform transition duration-200" />
                    <p className="text-skyblue-300 font-black text-3xl pt-6">
                        なぎさ
                    </p>
                        <p className="font-black pt-6 text-center">
                            水色担当のなぎさです！<br />
                ...
                <div className="flex flex-col items-center">
                    <img src= "/虹プロ画像/虹プロ画像/メッセージ/S__16629827.jpg" className="w-full h-auto rounded-xl hover:scale-110 transform transition duration-200" />
                    <p className="text-pink-300 font-black text-3xl pt-6">
                        ましろ
                    </p>
                        <p className="font-black pt-6 text-center">
                            ピンク担当のましろです！<br />
                ...
                <div className="flex flex-col items-center">
                    <img src= "/虹プロ画像/虹プロ画像/メッセージ/S__16629828.jpg" className="w-full h-auto rounded-xl hover:scale-110 transform transition duration-200" />
                    <p className="text-orange-300 font-black text-3xl pt-6">
                        ゆいと
                    </p>
                        <p className="font-black pt-6 text-center">
                            オレンジ担当のゆいとです！<br />
